...
STOCK_MANAGEMENT_SETTING = (
    ("by_default", "by_default"),
    ("disable_stock_management", "disable_stock_management"),
    ("manage_stock_by_hospital", "manage_stock_by_hospital"),
    ("manage_stock_by_hospital_after_bilisting", "manage_stock_by_hospital_after_bilisting"),
    ("manage_stock_by_patient_after_bilisting", "manage_stock_by_patient_after_bilisting")
)