POSOLOGY_TYPE = (
    ("standard_posology", "standard_posology"),
    ("specific_posology", "specific_posology"),
    ("cycle_posology", "cycle_posology"),
    ("each_posology", "each_posology"),
    ("from_to_posology", "from_to_posology")
